...
render() {
  ...
  return (
    <div className={styles.carItem}>
        ...
        <p className="description">Going by the results of this year’s JD Power Initial Quality Survey, though, that’s all wrong. “It’s almost the complete reverse,” says Dave Sargent, who oversees Power's vehicle quality research.</p>
